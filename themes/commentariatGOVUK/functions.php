...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		...
		'id' => 'leftpromo-widget-area',
		'description' => __( 'Promo bar widget area', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
	...
	register_sidebar( array(
		...
		'description' => __( 'The sidebar widget area on the homepage', 'twentyten' ),
	...
	register_sidebar( array(
		'name' => __( 'Table of Contents sidebar', 'twentyten' ),
		'id' => 'toc-widget-area',
		'description' => __( 'ToC sidebar widget area', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h2 class="widget-title">',
		'after_title' => '</h2>',
	...
	register_sidebar( array(
		'name' => __( 'Extra column', 'twentyten' ),
		'id' => 'col1-widget-area',
		'description' => __( 'The extra widget area on three-column pages', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h2 class="widget-title">',
		'after_title' => '</h2>',
